function [loglikehood, latents] = fMLchoiceLL_RL2conjdecayattn_constrained_2betas(xpar, sesdata)
%
...
beta_attn_feat_choice = xpar(NparamWithLR+1)*omega;
beta_attn_conj_choice = xpar(NparamWithLR+1)*(1-omega);
beta_attn_feat_learn = xpar(NparamWithLR+2)*omega;
beta_attn_conj_learn = xpar(NparamWithLR+2)*(1-omega);
...
for cnt_trial=1:ntrials
    ...
    attn_w_choice = attention_weights( ...
                    beta_attn_feat_choice*vf([idx_shape(1), idx_color(1), idx_pattern(1)])...
                   +beta_attn_conj_choice*vc([idx_patterncolor(1), idx_patternshape(1), idx_shapecolor(1)]), ...
                    beta_attn_feat_choice*vf([idx_shape(2), idx_color(2), idx_pattern(2)])...
                   +beta_attn_conj_choice*vc([idx_patterncolor(2), idx_patternshape(2), idx_shapecolor(2)]), ...
                    sesdata.attn_op, 1);
    attn_w_learn = attention_weights( ...
                    beta_attn_feat_learn*vf([idx_shape(1), idx_color(1), idx_pattern(1)])...
                   +beta_attn_conj_learn*vc([idx_patterncolor(1), idx_patternshape(1), idx_shapecolor(1)]), ...
                    beta_attn_feat_learn*vf([idx_shape(2), idx_color(2), idx_pattern(2)])...
                   +beta_attn_conj_learn*vc([idx_patterncolor(2), idx_patternshape(2), idx_shapecolor(2)]), ...
                    sesdata.attn_op, 1);
