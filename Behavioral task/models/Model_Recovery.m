...
all_sim_par_samples = {...
    @() [randn(1)/10 exp(log(1)+rand(1)*(log(50)-log(1))) ...
         unifrnd(0.005, 0.5, [1, 1]) unifrnd(0.05, 0.95, [1, 2])...
         exp(log(1)+rand(1)*(log(50)-log(1)))], ...
    @() [randn(1)/10 exp(log(1)+rand(1)*(log(50)-log(1))) rand(1) ...
         unifrnd(0.005, 0.5, [1, 1]) unifrnd(0.05, 0.95, [1, 2]) ...
         exp(log(1)+rand(1)*(log(50)-log(1)))], ...
    @() [randn(1)/10 exp(log(1)+rand(1)*(log(50)-log(1))) rand(1) ...
         unifrnd(0.005, 0.5, [1, 1]) unifrnd(0.05, 0.95, [1, 2]) ...
