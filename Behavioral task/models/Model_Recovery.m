...
p_temp_bound = 100;
attn_temp_bound = 250;
p_attn_temp_bound = 250;

all_lbs = {...
    [-bias_bound, bound_eps, bound_eps, bound_eps, bound_eps], ...
...
all_ubs = {...
    [bias_bound, temp_bound, 1-bound_eps, 1-bound_eps, attn_temp_bound], ...
...
all_plbs = {...
    [-p_bias_bound, bound_eps, bound_eps, bound_eps, bound_eps], ...
...
all_pubs = {...
    [p_bias_bound, p_temp_bound, 1-bound_eps, 1-bound_eps, p_attn_temp_bound], ...
...
all_sim_par_samples = {...
    @() [randn(1)/10 exp(log(1)+rand(1)*(log(100)-log(1))) ...
         unifrnd(0.005, 0.5, [1, 1]) unifrnd(0.05, 0.95, [1, 1])...
         exp(log(10)+rand(1)*(log(250)-log(10)))], ...
