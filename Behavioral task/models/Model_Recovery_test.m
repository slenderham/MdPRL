...
all_sim_par_samples = {...
    @() [randn(1)/10 exp(log(1)+rand(1)*(log(250)-log(1))) ...
         unifrnd(0.005, 0.25, [1, 1]) unifrnd(0.05, 0.95, [1, 2])...
         exp(log(10)+rand(1)*(log(250)-log(10)))], ...
    @() [randn(1)/10 exp(log(1)+rand(1)*(log(250)-log(1))) rand(1) ...
         unifrnd(0.005, 0.25, [1, 1]) unifrnd(0.05, 0.95, [1, 2]) ...
         exp(log(10)+rand(1)*(log(250)-log(10)))], ...
    @() [randn(1)/10 exp(log(1)+rand(1)*(log(250)-log(1))) rand(1) ...
         unifrnd(0.005, 0.25, [1, 1]) unifrnd(0.05, 0.95, [1, 2]) ...
...
%             disp(strcat("Simulating subject ", num2str(cnt_samp)));
            ...
            sim_ll = 100000
            while sim_ll > -trialLength*log(0.52)
