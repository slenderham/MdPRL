...
all_model_names = ["fMLchoiceLL_exemplar_static",...
                    "fMLchoiceLL_exemplar"];

all_model_Nparambasic = [3, 3];
all_model_Nalphas = [2, 2];
all_model_Nbetas = [3, 1];
...
all_lbs = {...
    [-bias_bound, temp_bound_eps, bound_eps, bound_eps, bound_eps, temp_bound_eps, temp_bound_eps, temp_bound_eps],...
    [-bias_bound, temp_bound_eps, bound_eps, bound_eps, bound_eps, bound_eps]};

all_ubs = {...
    [bias_bound, ch_temp_bound, 1-bound_eps, 1-bound_eps, 1-bound_eps, attn_temp_bound, attn_temp_bound, attn_temp_bound],...
    [bias_bound, ch_temp_bound, 1-bound_eps, 1-bound_eps, 1-bound_eps, 1-bound_eps]};

all_plbs = {...
    [-p_bias_bound, temp_bound_eps, bound_eps, bound_eps, bound_eps, temp_bound_eps, temp_bound_eps, temp_bound_eps],...
    [-p_bias_bound, temp_bound_eps, bound_eps, bound_eps, bound_eps, bound_eps]};

all_pubs = {...
    [p_bias_bound, p_ch_temp_bound, 1-bound_eps, 1-bound_eps, 1-bound_eps, p_attn_temp_bound, p_attn_temp_bound, p_attn_temp_bound],...
    [p_bias_bound, p_ch_temp_bound, 1-bound_eps, 1-bound_eps, 1-bound_eps, 1-bound_eps]};
...
for m = 1:length(all_model_names)
    ...
    for cnt_sbj = 1:length(subjects_inputs)
        ...
        for cnt_rep = 1:nrep
            ...
            if fval <= minfval
                minfval = fval ;
                fit_results{m, cnt_sbj}.params = xpar(1:NparamBasic+sesdata.Nalpha+sesdata.Nbeta);
                fit_results{m, cnt_sbj}.fval = fval ;
                fit_results{m, cnt_sbj}.iters = output.iterations;
                fit_results{m, cnt_sbj}.exitflag = exitflag ;
            end
        end
    end
    toc
