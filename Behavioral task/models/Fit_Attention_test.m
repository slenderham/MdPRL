...
all_lbs = {...
    [-bias_bound, temp_bound_eps, bound_eps, bound_eps, bound_eps, temp_bound_eps, temp_bound_eps], ...
    [-bias_bound, temp_bound_eps, bound_eps, bound_eps, bound_eps, bound_eps, temp_bound_eps, temp_bound_eps], ...
    [-bias_bound, temp_bound_eps, bound_eps, bound_eps, bound_eps, bound_eps, temp_bound_eps, temp_bound_eps], ...
    [-bias_bound, temp_bound_eps, bound_eps, bound_eps, bound_eps, bound_eps, temp_bound_eps, temp_bound_eps], ...
    [-bias_bound, temp_bound_eps, bound_eps, bound_eps, bound_eps, bound_eps, temp_bound_eps, temp_bound_eps]};

all_ubs = {...
    [bias_bound, temp_bound, 1-bound_eps, 1-bound_eps, 1-bound_eps, temp_bound, temp_bound], ...
    [bias_bound, temp_bound, 1-bound_eps, 1-bound_eps, 1-bound_eps, 1-bound_eps, temp_bound, temp_bound], ...
    [bias_bound, temp_bound, 1-bound_eps, 1-bound_eps, 1-bound_eps, 1-bound_eps, temp_bound, temp_bound], ...
    [bias_bound, temp_bound, 1-bound_eps, 1-bound_eps, 1-bound_eps, 1-bound_eps, temp_bound, temp_bound], ...
    [bias_bound, temp_bound, 1-bound_eps, 1-bound_eps, 1-bound_eps, 1-bound_eps, temp_bound, temp_bound]};

all_plbs = {...
    [-p_bias_bound, temp_bound_eps, bound_eps, bound_eps, bound_eps, temp_bound_eps, temp_bound_eps], ...
    [-p_bias_bound, temp_bound_eps, bound_eps, bound_eps, bound_eps, bound_eps, temp_bound_eps, temp_bound_eps], ...
    [-p_bias_bound, temp_bound_eps, bound_eps, bound_eps, bound_eps, bound_eps, temp_bound_eps, temp_bound_eps], ...
    [-p_bias_bound, temp_bound_eps, bound_eps, bound_eps, bound_eps, bound_eps, temp_bound_eps, temp_bound_eps], ...
    [-p_bias_bound, temp_bound_eps, bound_eps, bound_eps, bound_eps, bound_eps, temp_bound_eps, temp_bound_eps]};

all_pubs = {...
    [p_bias_bound, p_temp_bound, 1-bound_eps, 1-bound_eps, 1-bound_eps, p_temp_bound, p_temp_bound], ...
    [p_bias_bound, p_temp_bound, 1-bound_eps, 1-bound_eps, 1-bound_eps, 1-bound_eps, p_temp_bound, p_temp_bound], ...
    [p_bias_bound, p_temp_bound, 1-bound_eps, 1-bound_eps, 1-bound_eps, 1-bound_eps, p_temp_bound, p_temp_bound], ...
    [p_bias_bound, p_temp_bound, 1-bound_eps, 1-bound_eps, 1-bound_eps, 1-bound_eps, p_temp_bound, p_temp_bound], ...
    [p_bias_bound, p_temp_bound, 1-bound_eps, 1-bound_eps, 1-bound_eps, 1-bound_eps, p_temp_bound, p_temp_bound]};
nrep = 20;
...
cd ../files
save RPL2Analysis_Attention_lim_temp_500_rpe_40
cd ../models
