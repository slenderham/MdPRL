function loglikehood = fMLchoicefit_RL2ftdecayattnsepw(xpar, sesdata)
%
...
for cnt_trial=1:ntrials    
    ...
    pChoiceR = 1./(1+exp(-(magShape*attn_w_choice(1)*(v(idx_shape(2))-v(idx_shape(1))) ...
                         + magColor*attn_w_choice(2)*(v(idx_color(2))-v(idx_color(1))) ...
                         + magPattern*attn_w_choice(3)*(v(idx_pattern(2))-v(idx_pattern(1)))...
                         + BiasL))) ;
