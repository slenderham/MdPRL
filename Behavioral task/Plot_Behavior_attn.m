...
load('./files/RPL2Analysis_Attention') ;
...
RL2ftonj_decay_attn       = cat(1,mlparRL2conj_decay_attn{attn_modes(1), attn_modes(2), idxSubject}) ;
RL2ft_decay_attn          = cat(1,mlparRL2_ft_decay{attn_modes(1), attn_modes(2), idxSubject}) ;
RL2ftobj_decay_attn       = cat(1,mlparRL2ftobj_decay_attn{attn_modes(1), attn_modes(2), idxSubject}) ;
